...
<section class="advertisement-section advertisement-section2">
    <div class="advert-container">
        <div class="advertisement advertisement3">
            <div class="advert-information">
                <span>Invest in style today</span>
                <h2> TOPS </h2>
                <p>Traditional styling comes into its own in our range of tops. From casual Henley’s and sweatshirts to layering up in our shirts jackets and waistcoats.</p>
                <a href="">SHOP TOPS ></a>
            </div>
        </div>
        <div class="advertisement advertisement3">
