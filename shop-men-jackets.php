...
<?php require 'includes/nav.php'; ?>
    ...
    <section class="shop-headline">
        <h2 class="shop-heading">MEN'S JACKETS</h2>
        <p> Stay ahead of the weather with our durable and versatile vintage-inspired chore jackets
            and heavy-duty military-inspired coats. Perfect for all seasons,
            with a variety of styles and colours to choose from, buy yours today and be ready for any weather! </p>
