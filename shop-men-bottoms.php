...
<?php require 'includes/nav.php'; ?>
    ...
    <section class="shop-headline">
        <h2 class="shop-heading">MEN'S BOTTOMS</h2>
        <p> With great craftsmanship comes great long-lasting products, from every stitch to every seam. We respect the quality of strong design and applied labour, so our hard-wearing range of trousers,
            shorts and responsibly sourced denims are made practical and are designed to stand the test of time. </p>
